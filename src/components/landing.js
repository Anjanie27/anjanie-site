  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
        <div
          className="relative mx-auto w-full max-w-[480px] animate-fade-up"
        ...
        >
          ...
          <div className="group relative mt-8">
            <div className="absolute -inset-4 rounded-[2.25rem] bg-gradient-to-tr from-[#f9a8d4]/28 via-white/30 to-skyblue/24 blur-2xl transition-opacity duration-500 group-hover:opacity-90" />
            <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-white/55 p-3 shadow-2xl shadow-slate-500/15 backdrop-blur-xl transition-all duration-500 group-hover:rotate-1 group-hover:scale-[1.015]">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[1.5rem]">
                <Image
                  src="/images/cultural-photo.png"
                  alt="Anjanie Sukhnandan at Devi Mandir in traditional attire"
                  fill
